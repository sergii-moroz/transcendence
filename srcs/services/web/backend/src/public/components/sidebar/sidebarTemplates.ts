...
export const SidebarTemplates = {
	...
	friendList: () => `
		...
		<div id="sidebar-friends" class="z-50 w-80 h-dvh fixed right-0 dark:bg-gray-800 bg-white border-l dark:border-gray-700 border-gray-200 flex flex-col">
			...
			<div class="p-4 border-b border-t dark:border-gray-700 border-gray-200">
				<div class="relative">
				<input id="addFriendInput" type="text" placeholder="Add friend..." class="w-full dark:bg-gray-700 bg-gray-100 border-none rounded-lg pl-3 pr-10 py-2 text-base placeholder-gray-400 focus:ring-blue-500 focus:ring-2 duration-300 hover:scale-[1.02] hover:shadow-lgmake">
	...
	chat: () => `
		...
		<div id="sidebar-chat" class="z-50 w-80 h-dvh fixed right-0 dark:bg-gray-800 bg-white border-l dark:border-gray-700 border-gray-200 flex flex-col">
			<!-- Friend header -->
			...
			<div id="InputBar" class="p-4 h-[70px] border-t dark:border-gray-700 border-gray-200">
				<div id="inputField" class="relative">
					<input id="chat-input" type="text" placeholder="Type a message..." class="w-full dark:bg-gray-700 bg-gray-100 border-none rounded-lg pl-3 pr-10 py-2 text-base placeholder-gray-400 focus:ring-blue-500 focus:ring-2 duration-300 hover:scale-[1.02] hover:shadow-lg">
