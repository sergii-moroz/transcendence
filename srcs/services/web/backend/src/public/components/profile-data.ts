...
export class ProfileData extends HTMLElement {
	...
	constructor() {
		...
		this.innerHTML = '<h2 class="flex items-center justify-center">Loading...</h2>'
	}
				...
				<div class="flex p-4 space-x-6">
					<div class="flex flex-col">
						<div class="relative">
							...
							<div class="absolute z-50 inset-0 flex cursor-pointer items-center justify-center rounded-full bg-black/30 opacity-0 transition-opacity group-hover:opacity-100">
								${iconCamera}
							</div>
