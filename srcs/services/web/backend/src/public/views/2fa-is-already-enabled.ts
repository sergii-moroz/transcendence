...
export class isAlreadyEnabled2FAView extends View {
	setContent = () => {
			...
			<section>
				<div class="flex flex-col items-center justify-center px-6 py-8 mx-auto space-y-4">
					...
					>
						...
						>
							<p class="mx-auto">Two factor authentication is already enabled. Return to the settings page</p>
							<div class="text-5xl">🎉</div>
						</div>

						<!-- CARD: FOOTER -->
						<div class="flex items-center justify-end">
							<a href="/settings" data-link class="tw-btn w-24">Settings</a>
						</div>
					</div>
				</div>
			</section>
